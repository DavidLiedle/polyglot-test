...
// Verifies that the Dart tool-chain runs.
...
(function () {
        ...
        try {
          if (result === sentinelUndefined) {
            ...
            try {
              ...
              if (result === sentinelUndefined) this[fieldName] = null;
            }
  ...
  (function (callback) {
    ...
    if (typeof dartMainRunner === "function") dartMainRunner(V.main, []);
    else V.main([]);
  });
  // END invoke [main].
})();
